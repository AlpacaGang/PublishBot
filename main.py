...
FILENAME = f'../AlpacaKernel-v9-GCC-9.x-LTO-{TIMESTAMP.strftime("%y%m%d-%H%M")}.zip'
SIGNED_FILENAME = f'../AlpacaKernel-v9-GCC-9.x-LTO-{TIMESTAMP.strftime("%y%m%d-%H%M")}-signed.zip'
