...
FILENAME = f'../AlpacaKernel-r15-{TIMESTAMP.strftime("%Y%m%d-%H%M")}.zip'
SIGNED_FILENAME = f'../AlpacaKernel-r15-{TIMESTAMP.strftime("%Y%m%d-%H%M")}-signed.zip'
COMPILER_STRING = 'GCC 10.x'
KERNEL_VERSION = 'Alpaca, r15, LTO'
DEVICE = 'platina'
