...
MIUI_FILENAME = f'../AlpacaKernel-r16-MIUI-{TIMESTAMP.strftime("%Y%m%d-%H%M")}.zip'
MIUI_SIGNED_FILENAME = f'../AlpacaKernel-r16-MIUI-{TIMESTAMP.strftime("%Y%m%d-%H%M")}-signed.zip'
